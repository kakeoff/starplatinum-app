    ...
    <div class="relative p-6 md:p-16">
      ...
      >
        <div class="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
          ...
          >
            Мы заинтересованы в успешности Вашего продукта
          </h2>
          ...
          >
            <button
              type="button"
              class="hs-tab-active:bg-white hs-tab-active:shadow-md hover:scale-105 hover:transition duration-300 hs-tab-active:hover:border-transparent text-left hover:bg-gray-200 p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 dark:hover:bg-gray-700 active"
              ...
              <span class="flex">
                ...
                <span class="grow ml-6">
                  ...
                  <span
                    ...
                    >Наши сотрудники оформят вашу заявку в современном
                    эргономичном дизайне для наиболее эффективного привлечения
                    клиентов.</span
                  >
                </span>
              </span>
            ...
            <button
              type="button"
              class="hs-tab-active:bg-white hs-tab-active:shadow-md hover:scale-105 hover:transition duration-300 hs-tab-active:hover:border-transparent text-left hover:bg-gray-200 p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 dark:hover:bg-gray-700"
            ...
            >
              <span class="flex">
                ...
                <span class="grow ml-6">
                  <span
                    class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200"
                    >Умные алгоритмы продвижения</span
                  >
                  <span
                    class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200"
                    >Мы используем все современные технологии и алгоритмы для
                    продвижения. Сможете увидеть результат в кратчайшие
                    сроки.</span
                  >
                </span>
              </span>
            ...
            >
              <span class="flex">
                ...
                <span class="grow ml-6">
                  <span
                    class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200"
                    >Сделаем Ваш бренд узнаваемым</span
                  >
                  <span
                    class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200"
                    >Доверьте нам продвижение вашего бренда и увеличение продаж
                    с помощью мощных и эффективных рекламных стратегий.</span
                  >
                </span>
              </span>
            </button>
      ...
      <div class="absolute inset-0 grid grid-cols-12 w-full h-full">
        <div
          class="col-span-full lg:col-span-7 lg:col-start-6 bg-gray-100 w-full h-5/6 rounded-xl sm:h-3/4 lg:h-full dark:bg-[#252C50]/[.25]"
        ></div>
      </div>
