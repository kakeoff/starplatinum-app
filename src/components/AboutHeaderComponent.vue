  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        ...
        >
          Что такое <br />
          <span class="text-blue-600">STAR PLATINUM</span>
        </h1>
        <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">
          Мы - рекламное агентство, которое предлагает широкий спектр рекламных
          услуг для компаний и организаций всех размеров.
        </p>
        ...
        <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
          ...
          <div class="py-5">
            ...
            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
              <span class="font-bold">4.6</span> /5 - из 12000 отзывов
            </p>
          ...
          <div class="py-5">
            ...
            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
              <span class="font-bold">4.8</span> /5 - из 5000 отзывов
            </p>
