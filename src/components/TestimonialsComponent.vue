<template>
  <!-- Testimonials -->
  <div class="overflow-hidden my-[50px]">
    <div
    ...
    >
      ...
      <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
        <h2 class="text-2xl sm:text-3xl lg:text-4xl text-white font-semibold">
          Работаем с бизнес-компаниями и частными лицами по всей России
        </h2>
      </div>
      <!-- End Title -->
        ...
        <div class="flex h-auto">
          <div class="flex flex-col bg-white rounded-xl dark:bg-slate-900">
            <div class="flex-auto p-4 md:p-6">
              ...
              >
                " Star Platinum помогли нам значительно увеличить узнаваемость
                нашего бренда и улучшить результаты продаж благодаря
                качественной и эффективной рекламной кампании. "
              </p>
            </div>
          ...
          <div class="flex flex-col bg-white rounded-xl dark:bg-slate-900">
            <div class="flex-auto p-4 md:p-6">
              <p
                class="text-base italic md:text-lg text-gray-800 dark:text-gray-200"
              >
                " Очень довольны результатами работы с Star Platinum. Они
                предоставили нам индивидуальный подход и выстроили эффективную
                рекламную стратегию, которая превзошла наши ожидания. "
              </p>
            </div>
          ...
          <div class="flex flex-col bg-white rounded-xl dark:bg-slate-900">
            <div class="flex-auto p-4 md:p-6">
              <p
                class="text-base italic md:text-lg text-gray-800 dark:text-gray-200"
              >
                " Star Platinum профессионально выполняют свою работу и
                ориентированы на результат. Мы порекомендовали их нашим друзьям
                и партнерам, и они также остались довольны результатами. "
              </p>
            </div>
      ...
      >
        ...
        <div>
          ...
          <p class="mt-1 text-gray-400">за последний год</p>
        </div>
        <!-- End Stats -->
        ...
        <div>
          ...
          <p class="mt-1 text-gray-400">за все время</p>
        </div>
        <!-- End Stats -->
        ...
        <div>
          <h4 class="text-lg sm:text-xl font-semibold text-white">
            Известных бизнес-проекта
          </h4>
          <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">
            743
          </p>
          <p class="mt-1 text-gray-400">появившихся благодаря нам</p>
        </div>
        <!-- End Stats -->
      </div>
      <!-- End Grid -->
